...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_imports_loader_jQuery_jquery_this_window_webpack_raphael_raphael__ = __webpack_require__(1385);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_imports_loader_jQuery_jquery_this_window_webpack_raphael_raphael___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_imports_loader_jQuery_jquery_this_window_webpack_raphael_raphael__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_imports_loader_jQuery_jquery_this_window_govpredict_morris_morris__ = __webpack_require__(1382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_imports_loader_jQuery_jquery_this_window_govpredict_morris_morris___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_imports_loader_jQuery_jquery_this_window_govpredict_morris_morris__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Widget__ = __webpack_require__(198);
var _jsxFileName = 'D:\\FREELANCES\\Tesis Jean Claude Esquerra\\Code\\src\\pages\\charts\\morris\\Morris.js';
...
var MorrisCharts = function (_PureComponent) {
  _inherits(MorrisCharts, _PureComponent);

  function MorrisCharts() {
    _classCallCheck(this, MorrisCharts);

    return _possibleConstructorReturn(this, (MorrisCharts.__proto__ || Object.getPrototypeOf(MorrisCharts)).apply(this, arguments));
  }

  _createClass(MorrisCharts, [{
    ...
    key: 'initMorrisLineChart',
    value: function initMorrisLineChart() {
      __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this.morrisLineChart).html('');
      Morris.Line({
    ...
    key: 'initMorrisAreaChart',
    value: function initMorrisAreaChart() {
      __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this.morrisAreaChart).html('');
      Morris.Area({
    ...
    key: 'initMorrisBarChart',
    value: function initMorrisBarChart() {
      __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this.morrisBarChart).html('');
      Morris.Bar({
        element: this.morrisBarChart,
        resize: true,
        grid: false,
        data: [{ y: 4, x: 'Linux' }, { y: 12, x: 'MacOS' }, { y: 29, x: 'Windows' }],
        xkey: 'x',
        ykeys: ['y'],
        labels: ['OS Users, %'],
        barColors: ['#b7b3ff'],
    ...
    key: 'initMorrisBar2Chart',
    value: function initMorrisBar2Chart() {
      __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this.morrisBar2Chart).html('');
      Morris.Bar({
    ...
    key: 'initMorrisDonutChart',
    value: function initMorrisDonutChart() {
      __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this.morrisDonutChart).html('');
      Morris.Donut({
    ...
    key: 'initMorrisStackedChart',
    value: function initMorrisStackedChart() {
      __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this.morrisStackedChart).html('');
      Morris.Bar({
        element: this.morrisStackedChart,
        stacked: true,
        resize: true,
        data: [{ y: '2012', a: 3, b: 7, c: 90, d: 0 }, { y: '2013', a: 2, b: 7, c: 75, d: 14 }, { y: '2014', a: 3, b: 15, c: 65, d: 4 }, { y: '2015', a: 3, b: 17, c: 56, d: 20 }, { y: '2016', a: 5, b: 16, c: 49, d: 30 }, { y: '2017', a: 4, b: 20, c: 40, d: 36 }, { y: '2018', a: 5, b: 20, c: 40, d: 35 }],
        xkey: 'y',
        ykeys: ['a', 'b', 'c', 'd'],
        ...
        hoverCallback: function hoverCallback(index, options, content, row) {
          var keys = Object.keys(row).splice(1).sort();
          ...
          var rows = [];
          keys.forEach(function (value, id) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  ...
                  'Good-looking charts shouldn\'t be difficult. The public API is terribly simple. It\'s just one function: ',
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'code',
                    {
                      __source: {
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'text-center', ref: function ref(r) {
                    _this2.morrisLineChart = r;
                  }, style: { height: '343px' }, __source: {
                    fileName: _jsxFileName,
                    lineNumber: 198
                  },
                  __self: this
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'text-center', ref: function ref(r) {
                    _this2.morrisBarChart = r;
                  }, style: { height: '260px' }, __source: {
                    fileName: _jsxFileName,
                    lineNumber: 223
                  },
                  __self: this
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  ...
                  'Bar charts are also commonly referred to as a column charts. If you was trying to compare the height of something then intuitvely you would represent this by using columns. This really couldn\'t be easier. Create a Bar chart using ',
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'code',
                    {
                      __source: {
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'text-center', ref: function ref(r) {
                    _this2.morrisDonutChart = r;
                  }, style: { height: '180px' }, __source: {
                    fileName: _jsxFileName,
                    lineNumber: 239
                  },
                  __self: this
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  ...
                  'Donuts a great for representing some parted information like traffice sources, disk partitions, etc. This really couldn\'t be easier. Create a Donut chart using ',
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'code',
                    {
                      __source: {
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  ...
                  'This is generally a good chart to choose for all comparison based analysis but if you were to display a data set with negative values a column would be the best to represent this. This really couldn\'t be easier. Create a Bar chart using ',
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'code',
                    {
                      __source: {
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  ...
                  'Stacked charts are excellent to track some dynamics within declared categories. An example of this can be seen above. To create a Stacked Bar chart use ',
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'code',
                    {
                      __source: {
...
/* harmony default export */ __webpack_exports__["default"] = (MorrisCharts);
