    ...
    return (
      <div>
        <h2 className="page-title">
          Sing - <span className="fw-semi-bold">Package</span>&nbsp;
          <small>More than 2000 man-hours already invested!</small>
        </h2>
        <p className="lead">
          You will get access to all those versions listed below after you
          purchase any Sing licence!
        </p>
        <Row>
          <Col lg={5} md={6}>
            <Widget title={<h6>React JS Version</h6>} settings collapse close>
              <img
              ...
              <a
                className="btn btn-transparent btn-lg btn-block disabled"
                href="#"
              >
                (You are here)
              </a>
          ...
          <Col lg={5} md={6} xs={12}>
            <Widget title={<h6>Angular Version</h6>} settings collapse close>
              <img
                className={['rounded pull-left mb-1 mr-3', s.image].join(' ')}
                src={angularLogo}
                width="80"
              ...
              <p className="text-muted">
                We spent around <span className="fw-semi-bold">500</span>{' '}
                man-hours developing and designing Angular version, to match
              ...
              <p>
                ...
                is the most mature and wide spread front-end framework created
                by Google and used by many established enterprises. It is a very
                good choice when your expect your application to have a
                well-engineered structure and development workflow. If you are
                familiar with Java or .NET ecosystems Angular is definitely your
                choice.
              </p>
              <p>
                Our app is built on top of latest <strong>Angular 5.0</strong>{' '}
                version and uses <a href="https://webpack.js.org/">Webpack</a>{' '}
                Module Bundler and NPM as a package manager, so everything works
                out of the box! <br />
                <br />
              </p>
              <a
          ...
          <Col lg={5} md={6}>
            ...
            >
              ...
              <p className="text-muted">
                We don’t know about you but we’re very excited that it’s finally
                here! Our brand new Light Blue Angular version.
              </p>
              <p>
                <strong>Angular 1.0</strong> have so many opportunities in
                comparison to HTML. It lets you extend HTML vocabulary. And as a
                result your application can be very expressive and readable.
                <strong>Directives</strong> can hide complex DOM structure, CSS.
                They can let you invent new HTML syntax, specific to your
                application. We strongly believe that there’s nothing better
              ...
              <p>
                ...
                should be definitely among your top considerations when choosing
                the right framework.
              </p>
              <p>
                Angular version makes it possible by letting responsive,
                fast-loading and seamlessly-navigating application.
              </p>
              <a
                className="btn btn-default btn-lg btn-block"
          ...
          <Col lg={5} md={6} xs={12}>
            <Widget title={<h6>Pure HTML5 Version</h6>} settings collapse close>
              <img
                className={['rounded pull-left mb-1 mr-3', s.image].join(' ')}
                src={jsLogo}
                width="80"
          ...
          <Col lg={5} md={6}>
            <Widget title={<h6>Vue JS Version</h6>} settings collapse close>
              <img
                className={['rounded pull-left mb-1 mr-3', s.image].join(' ')}
                src={vueLogo}
                width="80"
              ...
              <p className="text-muted">
                ...
                <span className="fw-semi-bold">50%</span> ready.
              </p>
              <p>
                <a
                  href="https://reactjs.org/"
                ...
                is a an open-source progressive JavaScript framework for
                building user interfaces. Vue is designed to be incrementally
                adoptable meaning that adding new libraries is made incredibly
                easy.
              </p>
              <p>
                Creating Vue JS version is a main priority of{' '}
                <a href="https://flatlogic.com">Flatlogic</a> for next months,
                so seed version will ready really soon! <br />
                <br />
                <br />
                <br />
                <br />
