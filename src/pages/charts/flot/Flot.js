    ...
    return (
      <div>
        ...
        <h1 className="page-title">
          Visual - <span className="fw-semi-bold">Flot Charts</span>
        </h1>
        <Row>
          <Col xs={12} lg={6} xl={5}>
            <Widget
              title={
                <h5>
                  Flot <span className="fw-semi-bold">Stacked Line Chart</span>
                </h5>
              }
              close
              collapse
            >
              ...
              <p className="fs-mini text-muted">
                Flot is a <span className="fw-semi-bold">pure</span> JavaScript
                plotting library for jQuery, with a focus on simple usage,
                ...
                <Col xs={12} md={6}>
                  <div className="stats-row">
                    <div className="stat-item">
                      ...
                      <h6 className="name text-muted no-margin fs-mini">
                        Overall Values
                      </h6>
                    </div>
                    <div className="stat-item stat-item-mini-chart">
                      <div
                        className="sparkline"
                        ref={(r) => {
                          this.sparklines.push(r);
                        }}
                        data-type="bar"
                        data-bar-color="#FFC247"
                        data-height="30"
                        data-bar-width="6"
                        data-bar-spacing="2"
                      >
          ...
          <Col xs={12} lg={6} xl={7}>
            <Widget
              title={
                <h5>
                  Flot <span className="fw-semi-bold">Tracking</span>
                </h5>
              }
              close
              collapse
            >
              ...
              <p className="fs-mini text-muted">
                ...
                <span className="fw-semi-bold">powerful API</span>. But if you
                meet any troubles, you are always welcome to contact us to
                integrate the business logic into{' '}
                <span className="fw-semi-bold">SING Admin Dashboard</span>.
              </p>
            </Widget>
          </Col>
          <Col xs={12}>
            <Widget
              title={
                <h5>
                  Flot <span className="fw-semi-bold">Markers</span>
                </h5>
              }
              close
              collapse
            >
              ...
              <p className="fs-mini text-muted">
                Points can be marked in several ways, with circles being the
                built-in default.
              </p>
            </Widget>
          </Col>
          ...
          <Col xs={12} lg={5}>
            <Widget
              ...
              title={
                <h5>
                  Flot <span className="fw-semi-bold">Pie Chart</span>
                </h5>
              }
              close
              collapse
            >
              ...
              <p className="fs-mini text-muted">
                ...
                percentage of the pie (19% in this case).
              </p>
            </Widget>
            <Widget
              className="mb-xlg"
              title={
                <h5>
                  Flot <span className="fw-semi-bold">Donut Chart</span>
                </h5>
              }
              close
              collapse
          ...
          <Col xs={12}>
            <Widget
              ...
              title={
                <h5>
                  Flot <span className="fw-semi-bold">Bars Stacked</span>
                </h5>
              }
              close
              collapse
