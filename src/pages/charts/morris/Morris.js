          ...
          <Col lg={6} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Morris <span className="fw-semi-bold">Line Chart</span>
                </h5>
              }
              close
              collapse
            >
              <div>
                <p className="fs-mini text-muted">
                  ...
                  <code>Morris.Line(options)</code>, where options is an object
                  containing some of the following configuration options.
                </p>
                <div
          ...
          <Col lg={6} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Morris <span className="fw-semi-bold">Area Chart</span>
                </h5>
              }
              close
              collapse
          ...
          <Col lg={5} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Morris <span className="fw-semi-bold">Bar Chart</span>
                </h5>
              }
              close
              collapse
            >
              <div>
                <div
                  className="text-center"
                  ref={(r) => {
                    this.morrisBarChart = r;
                  }}
                  style={{ height: '260px' }}
                />
                <p className="fs-mini text-muted">
                  Bar charts are also commonly referred to as a column charts.
                  If you was trying to compare the height of something then
                  intuitvely you would represent this by using columns. This
                  really couldn&apos;t be easier. Create a Bar chart using{' '}
                  <code>Morris.Bar(options)</code>, with only few options.
                </p>
              </div>
            </Widget>
          </Col>
          <Col lg={3} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Morris <span className="fw-semi-bold">Donut Chart</span>
                </h5>
              }
              close
              collapse
          ...
          <Col lg={4} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Morris <span className="fw-semi-bold">Bar Chart 2</span>
                </h5>
              }
              close
              collapse
            >
              <div>
                <div
                  className="text-center"
                  ref={(r) => {
                    this.morrisBar2Chart = r;
                  }}
                  style={{ height: '180px' }}
                />
                <p className="fs-mini text-muted">
                  This is generally a good chart to choose for all comparison
                  based analysis but if you were to display a data set with
                  negative values a column would be the best to represent this.
                  This really couldn&apos;t be easier. Create a Bar chart using{' '}
                  <code>Morris.Bar(options)</code>, with only few options.
                </p>
              </div>
            </Widget>
          ...
          <Col xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Morris <span className="fw-semi-bold">Stacked Bar Chart</span>
                </h5>
              }
              close
              collapse
            >
              <div>
                <div
                  className="text-center"
                  ref={(r) => {
                    this.morrisStackedChart = r;
                  }}
                  style={{ height: '200px' }}
                />
                <p className="fs-mini text-muted">
                  Stacked charts are excellent to track some dynamics within
                  declared categories. An example of this can be seen above. To
                  create a Stacked Bar chart use{' '}
                  <code>Morris.Bar(options)</code> and set <code>stacked</code>,
                  option to true.
                </p>
              </div>
            </Widget>
