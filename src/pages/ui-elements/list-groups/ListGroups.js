...
const SortableItem = SortableElement(({ value }) => (
  <li className="list-group-item">
    ...
    <a className="close flex-last ml-auto" data-dismiss="alert">
      &times;
    </a>
    &nbsp;&nbsp;&nbsp; {value.id} &nbsp;&nbsp;&nbsp;
    {value.text}
    ...
    return (
      <div className={s.root}>
        ...
        <h1 className="page-title">
          Lists - <span className="fw-semi-bold">Sortable Groups</span>
        </h1>
        <Widget
          title={
            <h4>
              {' '}
              Grouped <span className="fw-semi-bold">Lists</span>
            </h4>
          }
          close
          refresh
...
export default withStyles(s)(ListGroups);
