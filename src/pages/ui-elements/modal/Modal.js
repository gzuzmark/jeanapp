    ...
    return (
      <div>
        ...
        <h1 className="page-title">
          Modal - <span className="fw-semi-bold">Examples</span>
        </h1>
        <Row>
          <Col xs={12} md={6}>
            <Widget
              ...
              title={
                <h5>
                  Live <span className="fw-semi-bold">Demo</span>
                </h5>
              }
              close
              collapse
            ...
            <Widget
              title={
                <h5>
                  Optional <span className="fw-semi-bold">Sizes</span>
                </h5>
              }
              close
              collapse
            >
              ...
              <Button color="primary" onClick={() => this.toggle('small')}>
                Small modal
              </Button>
            </Widget>
          </Col>
          <Col xs={12} md={6}>
            <Widget
              ...
              title={
                <h5>
                  Using <span className="fw-semi-bold">Grid</span>{' '}
                </h5>
              }
              close
              collapse
            >
              ...
              <div className="bg-light p-3">
                <Button color="primary" onClick={() => this.toggle('launch')}>
                  Launch
                </Button>
        ...
        <Modal size="sm" isOpen={small} toggle={() => this.toggle('small')}>
          ...
          <ModalFooter>
            <Button color="secondary" onClick={() => this.toggle('small')}>
              Close
            </Button>
            <Button color="primary">Save changes</Button>
          </ModalFooter>
        ...
        <Modal isOpen={launch} toggle={() => this.toggle('launch')}>
          ...
          <ModalBody className="bg-white text-white">
            <Container fluid>
              <Row>
                ...
                <Col md={4} className="ml-auto">
                  <div className="h-100 w-100 bg-primary p-2">
                    .col-md-4 .ml-auto
                  </div>
                </Col>
              </Row>
          ...
          <ModalFooter>
            <Button color="secondary" onClick={() => this.toggle('launch')}>
              Close
            </Button>
            <Button color="primary">Save changes</Button>
          </ModalFooter>
