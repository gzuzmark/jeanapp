  ...
  render() {
    ...
    return (
      <Row>
          ...
          <Widget
            title={
              <Row>
                <Col xs={4}>
                  <h6>Total Sales</h6>
                  <p className="value5">January, 2018</p>
                </Col>
                <Col xs={3}>
                  <h5>
                    <small>Best</small>
                  </h5>
                  <p className="value6 fs-sm">March, 2018 + 1</p>
                </Col>
              </Row>
            }
            settings
          ...
          >
            <div className="chart-stats">
              <p className="text-muted fs-mini mt-xs">
                ...
                <span className="fw-semi-bold text-gray-dark">Jess:</span> Seems
                like statically it&apos;s getting impossible to achieve any sort
                of results in nearest future. The only thing we can hope for is
        ...
        <Col lg={6} xs={12}>
          <Widget
            className=" widget-chart-stats-simple"
            title={
              <Row>
                <Col xs={12}>
                  <h6 className="mb-0">
                    <span className="fw-semi-bold">Budget</span>&nbsp;<Badge
                      pill
                      color="danger"
                    >
                      2017
                  ...
                  <span className="text-muted fs-mini">
              ...
              <div className="row">
                <div className="col-md-5">
                  <div className="clearfix m-t-1">
                    <h6 className="pull-left text-muted mb-xs">Income</h6>
                    <p className="pull-right h6 mb-xs">
                      <span className="fw-semi-bold">$14,595</span>
                    </p>
                  </div>
                  <div className="clearfix">
                    <h6 className="pull-left no-margin text-muted">Recent</h6>
