        ...
        <Widget>
          ...
          <Row>
            ...
            <Col md={7} xs={12}>
              ...
              <p>
                <a href="#" className="badge badge-warning rounded-0">
                  {' '}
                  UI/UX{' '}
                </a>
                <a href="#" className="badge badge-danger rounded-0 ml-2">
                  {' '}
                  Web Design{' '}
                </a>
                <a href="#" className="badge badge-default rounded-0 ml-2">
                  {' '}
                  Mobile Apps{' '}
                </a>
              </p>
      ...
      <Col lg={6} xs={12}>
        <section className="activities">
          ...
          <section className={s.event}>
            <header>
              <h5 className={s.eventTitle}>
                <a href="#">Jessica Smith</a> <small>@jess</small>
              </h5>
              <p className={s.eventTimestamp}>February 22, 2014 at 01:59 PM</p>
            </header>
            <div className={s.eventBody}>
            ...
            <footer className={s.eventFooter}>
              <div className="clearfix">
                ...
                <span className="thumb thumb-sm pull-right">
                  <a href="#">
                    <img className="rounded-circle" alt="..." src={a5} />
                  </a>
                </span>
                <span className="thumb thumb-sm pull-right">
                  <a href="#">
          ...
          <Form className="mt" action="#">
            ...
            <div className="btn-toolbar">
              ...
              <button type="submit" className="btn btn-danger btn-sm ml-auto">
                Post
              </button>
            </div>
          </Form>
