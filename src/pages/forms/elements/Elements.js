...
class Elements extends React.Component {
  constructor(props) {
    ...
    this.changeSelectDropdownSimple = this.changeSelectDropdownSimple.bind(
      this,
    );
    this.changeSelectDropdownGreen = this.changeSelectDropdownGreen.bind(this);
    this.changeSelectDropdownOrange = this.changeSelectDropdownOrange.bind(
      this,
    );
        ...
        <Row>
          ...
          <Col lg="6" md={12}>
            <Widget
              title={
                <h6>
                  <i className="fa fa-font" />Textareas
                </h6>
              }
              settings
              refresh
          ...
          <Col lg="6" md={12}>
            ...
            >
              <Form className="form-label-left">
                ...
                <FormGroup row>
                  {' '}
                  {/* todo: fix group select */}
                  <Label md="4" for="grouped-select">
                    Select with search & groups
                  </Label>
                  <Col md="6" className={s.select2}>
                    <Select2 data={this.state.selectGroupData} />
                  </Col>
                </FormGroup>
              </Form>
            ...
            <Widget title={<h6>Sliders</h6>} settingsInverse close refresh>
              <Row>
                <Col lg="4">
                  <h4>Color Options</h4>
                  <p>
                    Sing extends Bootstrap Slider and provides different color
                    options:
                  </p>
                  <Form>
                    <div className="mb-sm">
